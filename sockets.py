...
# Adapted from WebsocketExamples: https://github.com/abramhindle/WebSocketsExamples/blob/master/chat.py
# List of clients that are gevent.queues
clients = list()
...
# Adapted from my Ajax Assignment 4: https://github.com/jha8/CMPUT404-assignment-ajax
...
def world():
    ...
    world = myWorld.world()
    return flask.jsonify(world), 200

# Adapted from my Ajax Assignment 4: https://github.com/jha8/CMPUT404-assignment-ajax
@app.route("/entity/<entity>")    
def get_entity(entity):
    '''This is the GET version of the entity interface, return a representation of the entity'''
    entity_return = myWorld.get(entity)
    myWorld.clear()
    return flask.jsonify(entity_return), 200
